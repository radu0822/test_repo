...
def get_authentication_from_xcom(**kwargs):
...
def get_pull_request_from_xcom(**kwargs):
...
def get_commits_from_xcom(**kwargs):
...
def get_issues_from_xcom(**kwargs):
...
def get_branches_from_xcom(**kwargs):
